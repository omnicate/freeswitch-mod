...
vm_profile_t *profile_set_config(vm_profile_t *profile)
{
    ...
    SWITCH_CONFIG_SET_ITEM(profile->config[i++], "allow-password-change", SWITCH_CONFIG_BOOL, CONFIG_RELOADABLE, &profile->allow_password_change, SWITCH_TRUE, NULL, NULL, NULL);
